...
enum WorkoutTopic: UInt {
    case IndividualSports = 1
    case TeamSports = 2
    case ExerciseAndFitness = 3
    case StudioActivities = 4
    case RacketSports = 5
    case OutdoorActivities = 6
    case SnowAndIceSports = 7
    case WaterActivities = 8
    case MartialArts = 9
    case OtherActivities = 10
...
class WorkoutViewModel {
    ...
    init() {
        ...
        while let workoutType = WorkoutType(idx: idx) {
            ...
            if topic != .OtherActivities || workouts[topic.rawValue] == nil {
